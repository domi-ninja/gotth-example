...
func (app *App) HandleRegister_POST(w http.ResponseWriter, r *http.Request) {
	...
	if len(password) < 12 {
		RespondWithHtmlError(w, r, http.StatusOK, "Password must be at least 12 characters")
		return
	}
	...
	if err == nil {
		...
		RespondWithHtmlError(w, r, http.StatusOK, "User with this email already exists")
		return
	}
